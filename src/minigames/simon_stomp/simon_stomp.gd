		...
		. create(
			{
				...
				# Structured spec (#832/#844): the pad-stomp template shape — the four
				# directions collapse to the move cluster, avoiding a per-axis row
				# since those have no gamepad button glyph.
				"control_spec":
