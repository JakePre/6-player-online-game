...
| MDL-013 | #929 Cart Push | Mine cart: a classic wooden-slat mining cart with iron banding and four spoked wheels, heaped with glowing gold ore. The game's namesake object — must dominate its silhouette at iso distance (render audit: the current box cart is invisible). Pivot at base center, wheels touching ground. | ~1.8u long, ~1.2u tall | `assets/generated/models/mine-cart.glb` | generated |
| MDL-014 | #929 Bullet Waltz | Bullet emitter: an ornate music-box turret — a cylindrical brass music box with a rotating crank and small radial nozzles around its crown, elegant not military (the game is a waltz). Reads as "the danger source" at arena center. Pivot at base center. | ~1.2u tall | `assets/generated/models/music-box-emitter.glb` | generated |
| MDL-015 | #956 Turbo Lap | Go-kart: a chunky low-poly go-kart — open cockpit sized for a Kaykit rig to sit in, four fat wheels, a low spoiler. NEUTRAL grey/white body (the view tints panels per player color at runtime, so avoid baked-in saturated colors). Pivot at base center, wheels touching ground. | ~1.4u long, ~0.7u tall, seat at ~0.35u | `assets/generated/models/go-kart.glb` | generated |
