...
| MDL-009 | #918 Meteor Shower | Meteor: a craggy molten space rock, dark scorched crust with glowing orange-red fissures (painted-on albedo, not emissive geometry). Chunky low-poly, reads as danger falling from an isometric camera; roughly spherical silhouette so any spin looks right. Pivot at center. | ~1.2u diameter | `assets/generated/models/meteor.glb` | generated |
| MDL-010 | #919 King of the Hill | Hill crest: a low grassy mound/podium with a flat circular crest and gently sloped skirt — the zone players fight to hold. LOW profile (the zone drifts across the arena, so it must read fine sliding around); no roots, rocks, or overhangs past the base circle. Pivot at base center. | ~3u diameter, ~0.4u tall | `assets/generated/models/hill-crest.glb` | generated |
| MDL-011 | #919 King of the Hill | Shove horn: a chunky party air-horn / blast-horn pickup — canister with a flared bell, bold warning-orange body. Reads as "knockback item" at iso distance. Pivot at base center. | ~0.6u tall | `assets/generated/models/shove-horn.glb` | generated |
| MDL-012 | #919 King of the Hill | Anchor: a classic stylized ship anchor pickup — crossbar, curved flukes, thick shank, deep navy-blue with a lighter worn edge. Reads as "hold your ground" at iso distance. Pivot at base center. | ~0.7u tall | `assets/generated/models/anchor.glb` | generated |
| MDL-013 | #929 Cart Push | Mine cart: a classic wooden-slat mining cart with iron banding and four spoked wheels, heaped with glowing gold ore. The game's namesake object — must dominate its silhouette at iso distance (render audit: the current box cart is invisible). Pivot at base center, wheels touching ground. | ~1.8u long, ~1.2u tall | `assets/generated/models/mine-cart.glb` | requested |
| MDL-014 | #929 Bullet Waltz | Bullet emitter: an ornate music-box turret — a cylindrical brass music box with a rotating crank and small radial nozzles around its crown, elegant not military (the game is a waltz). Reads as "the danger source" at arena center. Pivot at base center. | ~1.2u tall | `assets/generated/models/music-box-emitter.glb` | requested |
| MDL-015 | #956 Turbo Lap | Go-kart: a chunky low-poly go-kart — open cockpit sized for a Kaykit rig to sit in, four fat wheels, a low spoiler. NEUTRAL grey/white body (the view tints panels per player color at runtime, so avoid baked-in saturated colors). Pivot at base center, wheels touching ground. | ~1.4u long, ~0.7u tall, seat at ~0.35u | `assets/generated/models/go-kart.glb` | requested |
| MDL-016 | #949 Blast Grid | Cursed skull token: a cartoonish purple-black skull pickup with faint emissive eye sockets — mischievous, not horror (it's a 50/50 gamble powerup). Reads as "risky" next to the plain powerups at iso distance. Pivot at base center. | ~0.5u tall | `assets/generated/models/skull-token.glb` | requested |
| MDL-017 | #954 Nom Arena | Power pellet: an oversized glowing orb pickup — warm white-gold core with a soft halo band, unmistakably "the special one" beside ordinary pellets. Simple sphere silhouette (the view pulses its scale/emission). Pivot at center. | ~0.6u diameter | `assets/generated/models/power-pellet.glb` | requested |
