...
| MDL-019 | #935 Hat Shop | Party cone hat: a classic conical birthday party hat — bright candy stripes (pink/white), a small pom-pom at the tip, a thin chin-elastic hint. Sits on a Kaykit rig's head bone. Reads as "party!" at iso distance. Replaces the primitive cone placeholder. Pivot at the brim base (head-bone origin). | ~0.4u tall | `assets/generated/models/hat-party-cone.glb` | requested |
| MDL-020 | #935 Hat Shop | Top hat: a tall stylized black top hat with a red band and a subtle satin sheen, slightly cartoon-proportioned (a touch wide-brimmed) so it reads at iso distance. Sits on a Kaykit rig's head bone. Replaces the primitive cylinder placeholder. Pivot at the brim base (head-bone origin). | ~0.4u tall, ~0.35u brim | `assets/generated/models/hat-top-hat.glb` | requested |
| MDL-021 | #935 Hat Shop | Gold crown: a chunky low-poly royal crown — five points tipped with tiny gem nubs, warm gold body with a jeweled band, worn-edge highlights. Sits on a Kaykit rig's head bone; the priciest wardrobe unlock, must read "champion." Replaces the primitive band placeholder. Pivot at the band base (head-bone origin). | ~0.25u tall, ~0.38u diameter | `assets/generated/models/hat-crown.glb` | requested |
