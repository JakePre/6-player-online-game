...
Owner-requested — [x] **M14-01** Loadout Duel (L, true 2D side-view per owner ruling on #509; design approved, build ⛓ M14-00) · [x] **M14-02** Turbo Lap (L) · [x] **M14-03** Knock-Off (L) · [ ] **M14-04** Shred Session (M) · [x] **M14-05** Ro-Sham-Bo Royale (S)
Approved — [x] **M14-06** Blast Grid (M) · [x] **M14-08** Putt Panic (M) · [ ] **M14-09** Tumble Run (L) · [x] **M14-10** Nom Arena (M, 60 s hard cap — owner wants it QUICK) · ~~M14-07 cut by owner~~
