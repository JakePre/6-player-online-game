...
Team — [ ] **M13-20** Tug of War (S, rope strain + heave dust; builds on #223) · [x] **M13-21** Color Clash (S, paint splats + coverage shimmer) · [ ] **M13-22** Relay Sprint (S, 2D: speed lines + baton flash) · [ ] **M13-23** Cart Push (S, wheel dust + strain anims — coordinate with #175 rework) · [x] **M13-24** Bomb Courier (S, fuse spark trail + handoff flash)
