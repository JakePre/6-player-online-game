...
Skill — [x] **M4-05** Simon Stomp (M) · [x] **M4-06** Quick Draw (S) · [x] **M4-07** Hurdle Dash (L) · [x] **M4-08** Target Range (M, mouse+stick aim) · [ ] **M4-09** Beat Bounce (M)
...
FFA — [x] **M10-01** Meteor Shower (M) · [ ] **M10-02** Musical Platforms (M) · [ ] **M10-03** Shock Tag (M) · [ ] **M10-04** Treasure Divers (M)
