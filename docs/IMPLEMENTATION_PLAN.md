...
Sabotage — [ ] **M10-13** The Mole (M) · [ ] **M10-14** Pickpocket Plaza (M) · [x] **M10-15** Bomb Courier (M) · [ ] **M10-16** Faulty Wiring (M)
...
- [ ] **M13-01** (M) Shared FX helpers: one-shot self-freeing impact bursts, pickup sparkles, splash + dust puffs (`src/minigames/_api/`), plus MinigameView3D convenience wrappers ⛓ none
FFA — [ ] **M13-02** Coin Scramble (S, coin pickup sparkle + spawn drop-in) · [ ] **M13-03** King of the Hill (S, zone shimmer + contest FX; pairs with #266) · [ ] **M13-04** Hot Potato (S, bomb trail + blast; builds on #219) · [ ] **M13-05** Thin Ice (S, crack decals + splash on falls) · [ ] **M13-06** Sumo Smash (S, shove impact + ring-out splash) · [ ] **M13-07** Meteor Shower (S, FALLING METEOR models: streak, impact burst, crater flash) · [ ] **M13-08** Musical Platforms (S, platform pulse on the beat + claim flash) · [ ] **M13-09** Shock Tag (S, zap arc on tags + crackle ring) · [ ] **M13-10** Treasure Divers (S, bubbles, dive splash, surface gasp)
Skill — [ ] **M13-11** Quick Draw (S, muzzle flash + holster anims) · [ ] **M13-12** Memory Match (S, tile flip/reveal animation) · [ ] **M13-13** Laser Limbo (S, beam hum shimmer + hit spark) · [ ] **M13-14** Bullseye Bowl (S, ball spin, ring hit flash, pin wobble) · [ ] **M13-15** Count Quick (S, swarm props as animated critters) · [ ] **M13-16** Simon Stomp (S, stomp ripples; pairs with #267) · [ ] **M13-17** Target Range (S, tracer + target break; pairs with #214) · [ ] **M13-18** Beat Bounce (S, beat-synced bounce FX; pairs with #264) · [ ] **M13-19** Fish Frenzy (S, SWIMMING FISH: lane fish that actually swim)
Team — [ ] **M13-20** Tug of War (S, rope strain + heave dust; builds on #223) · [ ] **M13-21** Color Clash (S, paint splats + coverage shimmer) · [ ] **M13-22** Relay Sprint (S, 2D: speed lines + baton flash) · [ ] **M13-23** Cart Push (S, wheel dust + strain anims — coordinate with #175 rework) · [ ] **M13-24** Bomb Courier (S, fuse spark trail + handoff flash)
Sabotage — [ ] **M13-25** Poison Feast (S — coordinate with #174 rework) · [ ] **M13-26** Trap Corridor (S, trap arm/spring animations) · [ ] **M13-27** Heist Night (S, 2D: blueprint scanline sweep + steal pulse)
Action & finale — [ ] **M13-28** Rumble Ring (S, swing arc FX; pairs with #263) · [ ] **M13-29** Bullet Waltz (S, bullet tracers + graze sparks) · [ ] **M13-30** Hurdle Dash (S, 2D: speed lines, hurdle clip spark) · [ ] **M13-31** Gauntlet finale (S, hazard telegraphs + platform crumble)
