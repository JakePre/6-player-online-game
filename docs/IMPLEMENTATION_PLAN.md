...
Sabotage — [ ] **M13-25** Poison Feast (S — coordinate with #174 rework) · [x] **M13-26** Trap Corridor (S, trap arm/spring animations) · [ ] **M13-27** Heist Night (S, 2D: blueprint scanline sweep + steal pulse)
