...
Action & finale — [x] **M13-28** Rumble Ring (S, swing arc FX; pairs with #263) · [ ] **M13-29** Bullet Waltz (S, bullet tracers + graze sparks) · [ ] **M13-30** Hurdle Dash (S, 2D: speed lines, hurdle clip spark) · [ ] **M13-31** Gauntlet finale (S, hazard telegraphs + platform crumble)
