...
| Shred Session per-lane drum one-shots (kick/snare/hat/tom, #585) — **original**, procedurally synthesized for this project (`docs`/scratch generator, deterministic seed), no third-party source. | `assets/audio/shred_drums/*.wav` | Party Rush project | CC0 1.0 (original) | — |
